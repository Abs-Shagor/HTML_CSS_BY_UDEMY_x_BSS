...
|----------------|----------|-------------|-----------------|
| **Leno**             | Leno: A modern, responsive landing page for showcasing app features, previews, details, and downloads with a user-friendly design. | [Link](https://leno99.netlify.app/) | [Visit](https://github.com/Abs-Shagor/HTML_CSS_BY_UDEMY_x_BSS/tree/main/14-Leno-Project) |
| **TuTor**            | Tutor: A video course platform for mastering professional skills with hands‑on, project‑based lessons. | [Link](https://tutor77.netlify.app/) | [Visit](https://github.com/Abs-Shagor/HTML_CSS_BY_UDEMY_x_BSS/tree/main/13-Tutor-Project) |
...
## Leno
![Leno Website](./12-Screenshots/tutor.png)
## TuTor
